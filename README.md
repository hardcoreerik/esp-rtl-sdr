...
**Not a librtlsdr port.** Clean-room Blog V4 USB profile · provisional Nooelec SMArt v5 · Blog V3 identity-only · stand-alone ESP-IDF component · fail-closed lifecycle
...
| **Dongle** | **RTL-SDR Blog V4** (primary) — `RTLSDRBlog` / `Blog V4`. **0.8.0-rc1** also recognizes provisional **Nooelec NESDR SMArt v5** and Blog V3 identity (no V3 stream). Bare `0bda:2838` is never assumed V4. |
