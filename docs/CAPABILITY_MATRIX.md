...
| 13 | Direct sampling / HF | forks | **V4 HF upconverter CAP** (RF+28.8e6; Cable-2/GPIO5). Nooelec rejects <24 MHz. V3 no stream. | **V4 Implemented (0.7.15/0.8.0-rc1), hardware acceptance open** |
