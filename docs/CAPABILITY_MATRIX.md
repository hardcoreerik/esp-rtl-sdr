...
| # | Desktop capability | librtlsdr (typical) | esp_rtl_sdr 0.5.0-dev | Phase |
|---|---|---|---|---|
...
| 11 | Frequency correction (ppm) | `set_freq_correction` | — | 2 |
...
| 15 | Multi-device index | `get_device_count`, open idx | single-session model | 2 |
| 16 | USB strings / serial | yes | `get_device_info` | **Partial** → 1 |
...
- **Partial:** works via related calls; ergonomic parity incomplete.
